...
public class allmabna {
    ...
    public static void main(String[] args) {
        while (true){
            ...
            for (Character ch : decimal_to(decimal,2)) {

                System.out.print(ch);
            }
            System.out.println();

            for (Character ch2 : decimal_to(decimal,8)) {
                System.out.print(ch2);
            }
            System.out.println();

            for (Character ch2 : decimal_to(decimal,16)) {
                System.out.print(ch2);
            }
            System.out.println();

            for (Character ch2 : decimal_to(decimal,10)) {
                System.out.print(ch2);
            }
